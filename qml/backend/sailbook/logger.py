...
LogFile:
    * Create a log file
    * Log the different type of logging levels to the log file when called from across Sailbook.
"""    
class _FileLogger:
    def __init__(self):
        ...
        logging.info("\n" + "-" * 100 + "\n" + " " * 46 + "LOGFILE \n\n   DATE: " + datetime.datetime.utcnow().isoformat() + "\n   NAME: " + constants.sailbook.name + "\n   VERSION: " + constants.sailbook.version+ "\n   PLATFORM: " + platform.machine() + "\n" + "-" * 100)
